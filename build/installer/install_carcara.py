...
GITHUB_VERSION_URL = "https://raw.githubusercontent.com/{}/{}/release/version.txt".format(GITHUB_REPO, GITHUB_BRANCH)
...
def install_carcara():
    ...
    try:
        ...
        source_folder = os.path.join(extracted_repo_folder, "release")

        if not os.path.exists(source_folder):
            cleanup_files(zip_path, temp_extract_folder)
            return "Error: 'release' folder not found in repository. Expected path: {}".format(source_folder)
